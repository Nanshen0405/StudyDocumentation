...
Java后端程序员必备面试宝典，包含计算机网络、关系型数据库、Redis、Linux系统、Java基础、JVM、Spring全家桶、多线程和并发以及Java常用框架等模块，深受广大程序员的好评。
...
<img src="图片/内存分配的两种方式.png" alt="内存分配的两种方式" style="zoom:150%;" />
